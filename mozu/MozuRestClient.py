...
class MozuRestClient:
    ...
    def __init__(self, **kwargs):
        ...
        document_content_api = ''
        self.document_content_api = document_content_api # self.tenant_url + "/api/content/documentlists/" + self.listFQN + "/documents/" + self.mz_imageid + "/content"
    ...
    def __repr__(self):
        ...
        return "MZID: %s - BFID: %s" % (self.mz_imageid, self.bf_imageid,)
    ...
    def delete_mz_image(self):
        ...
        self.http_status_code = _document_response.status_code
        print "DocumentDeleteResponse: %s" % _document_response.status_code
        try:
            return _document_response.json()
        except KeyError:
            return _document_response
