...
def get_media_version_number(colorstyle):
    ...
    # Multiple
qry= "SELECT DISTINCT POMGR.PRODUCT_COLOR_DETAIL.PRODUCT_COLOR_ID AS colorstyle, POMGR.PRODUCT_COLOR_DETAIL.MEDIA_VERSION    AS media_version, POMGR.PRODUCT_COLOR_DETAIL.MAIN_IMAGE as m0, POMGR.PRODUCT_COLOR_DETAIL.ZOOM_IMAGE as z0, POMGR.PRODUCT_COLOR_DETAIL.ALTERNATE_IMAGE_1 as a1, POMGR.PRODUCT_COLOR_DETAIL.ALTERNATE_IMAGE_2 as a2, POMGR.PRODUCT_COLOR_DETAIL.ALTERNATE_IMAGE_3 as a3, POMGR.PRODUCT_COLOR_DETAIL.ALTERNATE_IMAGE_4 as a4, POMGR.PRODUCT_COLOR_DETAIL.ALTERNATE_IMAGE_5 as a5, POMGR.PRODUCT_COLOR_DETAIL.MAIN_IMAGE_SWATCH as swatch FROM POMGR.PRODUCT_COLOR_DETAIL WHERE POMGR.PRODUCT_COLOR_DETAIL.PRODUCT_COLOR_ID IN ('{}')".format("', '".join(colorstyle))
        # Multiple
        # qry= """SELECT DISTINCT
