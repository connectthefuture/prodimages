...
dailyPhpMyAdminForImport=$SCRIPTS/sql/skuStylePMimport.sql

dbOutRaw=$PRODSRV/tmp/limbo/spoolDWMerchantTags.csv
dbOutClean=$PRODSRV/data/csv/sampleskuimport.csv
