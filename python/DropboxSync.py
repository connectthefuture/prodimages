...
sys.path += [os.path.join(os.path.dirname(os.path.abspath(__file__)), 'Login')]

import dropboxlogin
# this code can be found here https://gist.github.com/4034526
...
class dropbox_state:
	...
	def execute_delta(self, client, ignore_path = ('sceneimages/', 'django/', 'gdata/')):
