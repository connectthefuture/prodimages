...
"""Module to fork the current process as a daemon.
   NOTE: don't do any of this if your daemon gets started by inetd!  inetd does all you need, including redirecting standard file descriptors;
...
def daemonize(stdin='/dev/null', stdout='/dev/null', stderr='/dev/null'):
    ...
    # Decouple from parent environment. os.chdir("/")
    os.umask(0)
    os.setsid()
