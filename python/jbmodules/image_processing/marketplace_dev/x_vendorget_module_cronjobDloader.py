...
def sqlQuery_GetIMarketplaceImgs(vendor='_', vendor_brand='', po_number='', ALL='', **kwargs):
    ...
    if kwargs.get('q'):
        query_marketplace_inprog = update_q(vendor=kwargs.get('vendor'), date_range=kwargs.get('date_range'))
