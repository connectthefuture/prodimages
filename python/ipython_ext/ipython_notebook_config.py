...
### nbextensions
c.NotebookApp.nbextensions_path = ['nbextensions/']
...
# keyfile : filepath
#     The file containing a key.  If this is set,  will be initialized
#     to the contents of the file.

# Username for the Session. Default is your system username.
# c.Session.username = u'johnb'
...
# The figure format to enable (deprecated use  instead)
...
# save.  This can also be set with the short  flag.
