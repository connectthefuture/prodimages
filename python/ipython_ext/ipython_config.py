...
c.InteractiveShellApp.exec_files = ['/usr/local/batchRunScripts/python/pythonstartup.py']

# A file to be run
c.InteractiveShellApp.file_to_run = '/usr/local/batchRunScripts/python/pythonstartup.py'
...
c.TerminalIPythonApp.profile = u'jb'
...
c.TerminalIPythonApp.ipython_dir = u'/home/johnb/.ipython'
...
c.TerminalInteractiveShell.logfile = u'/home/johnb/.ipython/ipython_logfile.log'
...
# than working
c.TerminalInteractiveShell.cache_size = 2000
