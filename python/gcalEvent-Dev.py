...
#            complete_styles.append(colorstyle)
###
#        complete_styles = '\n'.join(complete_styles)
#        Complete_Styles_Template = Template('${count_complete} Styles Remaining to Complete:\n\t\t${complete_styles}')
#        Complete_Styles = Complete_Styles_Template.substitute(count_complete=count_complete, complete_styles=complete_styles)
##
###
##
#        html_incomplete = []
...
#            incomplete_styles.append(colorstyle)
###
#        incomplete_styles = '\n'.join(incomplete_styles)
#        Incomplete_Styles_Template = Template('${count_incomplete} Styles Remaining to Complete:\n\t\t${incomplete_styles}')
#        Incomplete_Styles = Incomplete_Styles_Template.substitute(count_incomplete=count_incomplete, incomplete_styles=incomplete_styles)
##
###
##
#        CompletionList_Template = Template('Total Incomplete: ${count_incomplete}\n${Incomplete_Styles}\nTotal Complete: ${count_complete}\n${Complete_Styles}')
#        CompletionList = CompletionList_Template.substitute(count_incomplete=count_incomplete, Incomplete_Styles=Incomplete_Styles, count_complete=count_complete, Complete_Styles=Complete_Styles)
###
#        descCompleteStatus = "<table><tr>{CompletionList}</tr></table>".format(CompletionList=CompletionList)
###
        if len(incomplete) == 0:
...
#####   print titleid, descfull, edatekv, prod_category, lockv
        gcal_insert_bc_event(titleid, descfull, lockv, sdatekv,
                             ...
                             myemail='john.bragato@gmail.com',
                             password='yankee17')
#        print "Count {0} {1}".format(count, titleid)
#        try:
...
#        except xml.parsers.expat.ExpatError:
#        ###        #except:
#            print "FAILED {0}".format(titleid) #+ k,v
#        except AttributeError:
#            print "AttributeError {0}".format(titleid)
    #    continue