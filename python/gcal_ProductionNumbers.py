...
def sql_query_production_numbers():
    ...
    querymake_prodnumbers = '''SELECT COUNT(DISTINCT POMGR.PRODUCT_COLOR.PRODUCT_COLOR_ID) as completion_total, POMGR.PRODUCT_COLOR.PRODUCTION_COMPLETE_DT as prod_complete_dt
