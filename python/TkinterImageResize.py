...
optlist = EasyDialogs.GetArgv(str, cmd, addoldfile=False, addnewfile=False, addfolder=True)
...
if score == 1:
    EasyDialogs.Message("Wwowowowow, This is Somethin ;-)")
elif score == 0:
    EasyDialogs.Message("Sigh, sorry, will do better next time!-(")
elif score == -1:
    EasyDialogs.Message("Hey, you didnt enter a thing. Might you want to try again?!")
