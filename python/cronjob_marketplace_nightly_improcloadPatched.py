...
def sqlQuery_GetIMarketplaceImgs(vendor=None,vendor_brand=None, po_number=None, all_flag=None, updateonly_flag=''):
...
countimage = 0
countstyle = 0
vaultstyles=sqlQuery_GetIMarketplaceImgs(vendor='', vendor_brand='', po_number='', all_flag='AllCronRun', updateonly_flag=updateonly_flag)
