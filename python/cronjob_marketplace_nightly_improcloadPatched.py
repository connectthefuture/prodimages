...
def sqlQuery_GetIMarketplaceImgs(vendor=None,vendor_brand=None, all_flag=None):
...
countimage = 0
countstyle = 0
vaultstyles=sqlQuery_GetIMarketplaceImgs(vendor='', vendor_brand='', all_flag='AllCronRun')
