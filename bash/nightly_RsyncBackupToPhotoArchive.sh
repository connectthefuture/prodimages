...
sleep 5 && exiftool -r -o ${tmpPhotoSelects} '-Directory='${tmpPhotoSelects}'/%4f/%9f' ${pushStill}/ -ext jpg & exiftool -r -o ${tmpPhotoSelects} '-Directory='${tmpPhotoSelects}'/%4f/%9f' ${pushFashion}/ -ext jpg \;
...
sleep 25 && find ${pushStill} ${pushFashion} -type d -mindepth 1 -maxdepth 1 -ctime +5 -exec mv -p {} ${tmpDeletePhoto} \;
    ##Clear TempDelete Folder, DELETING ALL FOLDERS over 10 days old
#find ${tmpDeletePhoto} -type d -mindepth 1 -maxdepth 1 -ctime +10 -exec rm -R {} \;
