...
#dailyPhpMyAdminForImport=/mnt/Post_Complete/CSV_updates/PrdExtra_Photoshop_Logs/phpImportTOrelation_PM_SchemasTables_sqlInsert/DailyImportTophpMyAdmin_SQL.sql
dailyPhpMyAdminForImport=$SCRIPTS/sql/prodsnapshot_import.sql

dbOutRaw=$PRODSRV/tmp/limbo/spoolpmaimportprodsnapshot.csv
dbOutClean=$PRODSRV/data/csv/product_snapshot.csv
