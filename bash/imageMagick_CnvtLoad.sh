...
MAGICK_LOAD=$PRODSRV/var/magick/load

##### Replace _1 etc in FileNames
userDropFolders=$PRODSRV/tmp/drop_Retouchers
...
convertedFolder_png=$MAGICK_LOAD/a_Drop_to_Load/PNG_Primary/
convertedFolder_l=$MAGICK_LOAD/a_Drop_to_Load/L_JPG/
convertedFolder_m=$MAGICK_LOAD/a_Drop_to_Load/M_JPG/
convertedFolder_alt=$MAGICK_LOAD/a_Drop_to_Load/ALT_JPG_PNG/
