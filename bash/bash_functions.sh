...
function cache_clear_dir_postapi ()
{
    ...
    curl -u looklet:L00klet --header 'Authentication: ApiKey=fb49f24a29060a350628fd9e9fb08b3b9762abbd;' -d colorstyle="${f}" -X POST http://prodimages.ny.bluefly.com/image-update/
