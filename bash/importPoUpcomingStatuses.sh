...
dailyPhpMyAdminForImport=$SCRIPTS/sql/po_upcoming_style_status.sql

dbOutRaw=$PRODSRV/tmp/limbo/spool_upcomingpos.csv
dbOutClean=$PRODSRV/data/csv/po_upcoming_style_status.csv
