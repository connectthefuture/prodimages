...
/usr/local/batchRunScripts/bash/view_events_progress.sh | sed -e 's/\<TD\>Production\ Incomplete\<\/TD\>/\<TD\ style\=\"background\-color\:rgb\(250,75,90\)\"\>Production\ Incomplete\<\/TD\>/g' > /mnt/Post_Ready/zImages_1/dag/sites/queries_PHP-test1/Reports/event_progress_14days.html && php -f /usr/local/batchRunScripts/php/eventmail_sp.php
