...
//            else $mailto  =   "john.bragato@bluefly.com";
         ...
         else $mailto  =   "john.bragato@bluefly.com,stephen.parker@bluefly.com,jacqueline.wahba@bluefly.com,james.hoetker@bluefly.com,meghan.mcbride@bluefly.com,conrad.sanderson@bluefly.com,desiree.guery@bluefly.com,paul.kamau@bluefly.com";
...
// 	//else
	...
	$attachment = "/mnt/Post_Ready/zImages_1/dag/sites/queries_PHP_test1/Reports/event_incomplete_14days.html";
// 		
		$htmlbody		= shell_exec("cat " . $attachment);
 		$textbody		= shell_exec("cat " . $attachment);
