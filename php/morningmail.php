...
//	require_once('/opt/local/lib/php/pear/Mail/smtp.php');
	...
	if(isset($_POST['mailto'])) $mailto   			= $_POST['mailto'];
        else $mailto  =   "john.bragato@bluefly.com,stephen.parker@bluefly.com,james.hoetker@bluefly.com,conrad.sanderson@bluefly.com,";
	if(isset($_POST['mailsubject'])) $mailsubject   = $_POST['mailsubject'];
        else $mailsubject  =   "Retouch to do Breakdown";
